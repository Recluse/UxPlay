...
struct raop_callbacks_s {
    ...
    void  (*video_report_size)(void *cls, float *width_source, float *height_source, float *width, float *height, int rotation_hint); /* PATCH: rotation_hint = packet[5] of codec packet, encodes iPhone orientation */
